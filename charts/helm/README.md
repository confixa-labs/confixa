...
| apiGateway.image.tag | string | `"sha-084418bccdbd8bd8790f4c6b7e6be7ea6b627c65"` |  |
...
| kubernetesdashboard.enable | bool | `false` |  |
...
| kubernetesdashboard.metricsScraper.enable | bool | `false` |  |
...
| kubernetesdashboard.service.targetPort | int | `9090` |  |
...
| llmKumaApiGateway.enable | bool | `false` |  |
...
| llmKumaApiGateway.image.tag | string | `"8d2c2284247a38a96c85792ed190c92ce4f7f8e6"` |  |
| llmKumaApiGateway.name | string | `"confixa-llm-kuma-api"` |  |
| llmKumaApiGateway.ports.containerPort | int | `5050` |  |
| llmKumaApiGateway.ports.protocol | string | `"TCP"` |  |
| llmKumaApiGateway.replicas | int | `1` |  |
| llmKumaApiGateway.resources.limits.cpu | string | `"500m"` |  |
| llmKumaApiGateway.resources.limits.memory | string | `"512Mi"` |  |
| llmKumaApiGateway.resources.requests.cpu | string | `"100m"` |  |
| llmKumaApiGateway.resources.requests.memory | string | `"128Mi"` |  |
| llmKumaApiGateway.service.port | int | `80` |  |
| llmKumaApiGateway.service.protocol | string | `"TCP"` |  |
| llmKumaApiGateway.service.targetPort | int | `5050` |  |
